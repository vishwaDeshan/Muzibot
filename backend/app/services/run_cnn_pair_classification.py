...
from tensorflow.keras.layers import Input, Dense, Dropout, Conv1D, MaxPooling1D, Flatten # type: ignore
import matplotlib.pyplot as plt
import pickle
import os

# Define output directory
output_dir = "../artifacts/cnn"
...
# Reshape for CNN
pairs = pairs.reshape(-1, pairs.shape[1], 1)
...
input_shape = (feature_vectors.shape[1] * 2, 1)
...
# Evaluate the model
val_pred = (cnn_model.predict(pairs_val) > 0.5).astype(int)
...
print("Saved CNN model in HDF5 (.h5) format")
